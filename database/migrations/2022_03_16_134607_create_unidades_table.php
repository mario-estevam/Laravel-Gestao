...
class CreateUnidadesTable extends Migration
{
    ...
    public function up()
    {
        ...
        // adicionar relacionemtno com a tabela produtos
    ...
    {
        // remover relacionemtno com a tabela produtos_detalhes
        Schema::table('produtos_detalhes', function(Blueprint $table){
            //remover a fk
           $table->dropForeign('produtos_detalhes_unidade_id_foreing');
           //remover a coluna
